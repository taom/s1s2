    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.topBar}>
          <View>
            <Text style={styles.shipName}>Unnamed Vessel</Text>
            <Text style={styles.shipClass}>Pod Class</Text>
          </View>
          <View style={styles.topRight}>
            ...
            <View style={styles.xpBadge}>
              <Text style={styles.xpText}>Lv 1</Text>
            </View>
          </View>
        </View>
        ...
        >
          <View style={styles.viewportInner}>
            ...
            <Text style={styles.systemName}>Awaiting First Signal...</Text>
